...
const formInputs = [
  ...
  { name: 'customer_email', label: 'Email', type: 'text', required: true },
  { name: 'phone', label: 'Phone', type: 'text', required: false },
  { name: 'shipping_address.address_1', label: 'Shipping Address', type: 'text', required: true },
  { name: 'shipping_address.city', label: 'City', type: 'text', required: true },
  { name: 'shipping_address.state', label: 'State', type: 'text', required: true },
  { name: 'shipping_address.zip', label: 'Zip Code', type: 'text', required: true },
  ...
  { name: 'billing_address.city', label: 'City', type: 'text', required: false, isBilling: true },
  { name: 'billing_address.state', label: 'State', type: 'text', required: false, isBilling: true },
  { name: 'billing_address.zip', label: 'Zip Code', type: 'text', required: false, isBilling: true },
